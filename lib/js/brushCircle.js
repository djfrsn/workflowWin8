...
var circle = $('.circle'); // this element fades in, pulses infinitely & fades out
    ...
    var hideEleDelay = 1600; // this setting is needed to run a timeout to return the                                                                                              
    ...
    {
        $('.pm-quote').addClass('fadeOut');
        circle.addClass('expandCircle');
    }
    
    $('.pulseTrigger').on('click', function() {
            expandCircle();
        });
